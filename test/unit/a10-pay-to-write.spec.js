    ...
    it('should throw error if txid is not provided', async () => {
      try {
        const options = {
          ...
          url: `${LOCALHOST}/ptwdb`,
          data: {
            signature: 'H+S7OTnqZzs34lAJW4DPvCkLIv4HlR1wBux7x2OxmeiCVJ8xDmo3jcHjtWc4N9mdBVB4VUSPRt9Ete9wVVDzDeI=',
            message: 'A message'
          }
        }
    ...
    it('should throw error if signature is not provided', async () => {
      try {
        const options = {
          ...
          url: `${LOCALHOST}/ptwdb`,
          data: {
            txid: '7429dff697633eb43efbea5d8552cec4911b780bf5eb4bc748fca4eed2cb8faa',
            message: 'A message'
          }
        }
